  ...
  try {
    if (action === 'start') {
      ...
      if (pose === 'sitting_side') {
        ...
        postureDescription = "standing up on its own on a soft fluffy rug, standing freely and independently, balancing by itself with both arms relaxed and hanging naturally at the sides (not holding onto anything), looking at the camera. There is NO sofa, NO cushion, NO pillow, NO rolled-up blanket, NO stool, NO supporting hand and NO prop or object of any kind in the scene. Shot at the baby's eye level, horizontal camera angle, perfectly straight-on view, strictly NOT looking down from above";
