  ...
  try {
    if (action === 'start') {
      ...
      if (pose === 'sitting_side') {
        ...
        sceneDescription = "The baby is lying on a soft, thick, plush, cushioned cream-colored rug or blanket (the same cozy soft rug used in other shots), which looks comfortable and not hard. Flat lay photo shot directly from straight above (top-down overhead bird's-eye view), camera pointing straight down at the baby, the whole body laid out flat in the frame. Wide angle shot, zoomed out.";
      }
